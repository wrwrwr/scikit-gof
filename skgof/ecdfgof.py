...
ks_test = partial(ecdfgof_test, stat=ks_stat, pdist=ks_unif)
cvm_test = partial(ecdfgof_test, stat=cvm_stat, pdist=cvm_unif)
ad_test = partial(ecdfgof_test, stat=ad_stat, pdist=ad_unif)
